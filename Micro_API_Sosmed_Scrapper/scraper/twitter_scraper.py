...
class Twitter_Scraper:
    ...
    """
                ...
                if retries < max_retries:
                    ...
                    print("Maximum number of login retries reached. Exiting...")
                    self.driver.quit()
                    sys.exit(1)
...
- Twitter is experiencing unusual activity"""
    ...
    def save_to_json(self):
        ...
        current_time = now.strftime("%Y-%m-%d_%H-%M-%S")
        file_path = f"{folder_path}{current_time}_tweets.json"
    ...
    def run(self):
        ...
        self.scrape_tweets_daily()
            
    def is_logged_in(self):
        """
        Check if the user is already logged in by examining the current URL.
        """
        current_url = self.driver.current_url
        return not current_url.startswith(TWITTER_LOGIN_URL)
